...
public List<Map<String, Object>> getAppointments(String jwtToken) {
    ...
    public List<Map<String, Object>> getSolicitudes(String jwtToken) {
    HttpHeaders headers = new HttpHeaders();
    headers.set("Authorization", "Bearer " + jwtToken);
    HttpEntity<Void> entity = new HttpEntity<>(headers);
    try {
        ResponseEntity<Map[]> response = restTemplate.exchange(
                backendBaseUrl + "/solicitudes",
                HttpMethod.GET,
                entity,
                Map[].class);
...
public Map<String, Object> crearSolicitud(Map<String, Object> body, String jwtToken) {
    HttpHeaders headers = new HttpHeaders();
    headers.set("Authorization", "Bearer " + jwtToken);
